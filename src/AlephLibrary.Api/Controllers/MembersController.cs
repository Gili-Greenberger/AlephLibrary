...
namespace AlephLibrary.Api.Controllers
{
    ...
    public class MembersController : ControllerBase
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public Task<List<MemberDto>> GetAll() => _svc.GetAllAsync();
        ...
        public Task<MemberDto> Create(CreateMemberDto dto) => _svc.AddAsync(dto);

        [HttpPut("{id:int}")]
        [Authorize(Roles = "Admin")]
        public Task<MemberDto> Update(int id, UpdateMemberDto dto) => _svc.UpdateAsync(id, dto);
